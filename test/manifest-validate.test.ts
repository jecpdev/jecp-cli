/**
 * Hand-rolled validator tests against the JECP manifest schema.
 *
 * These are pure validator tests — no CLI command, no fs, no fetch.
 * The CLI wrapper tests live in commands/validate.test.ts.
 */
